...
const CreateAppointment: React.FC = () => {
  ...
  const handleCreateAppointment = useCallback(async () => {
    try {
      ...
      Alert.alert('Erro ao criar agendamento', 'Ocorreu ao tentar criar o agendamento, tente novamente');
    }
  ...
  return (
    <Container>
      <Header>
        ...
        <UserAvatar
          source={{
            uri: user.avatar_url || 'https://api.adorable.io/avatars/56/abott@adorable.png',
          }}
        />
      </Header>
          ...
          <ProvidersList
            ...
            renderItem={({ item: provider }) => (
              ...
              >
                <ProviderAvatar
                  source={{
                    uri: provider.avatar_url || 'https://api.adorable.io/avatars/32/abott@adorable.png',
                  }}
                />
